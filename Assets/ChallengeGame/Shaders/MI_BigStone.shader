Shader "Unreal/MI_BigStone"
{
    Properties
    {
		...
		Material_Texture2D_1( "T_RockDetail_01_Normal", 2D ) = "white" {}
		Material_Texture2D_2( "T_RockDetail_02_Normal", 2D ) = "white" {}
		Material_Texture2D_3( "T_Landscape_Grass_01_Normal", 2D ) = "white" {}
		Material_Texture2D_4( "Color Texture", 2D ) = "white" {}
		Material_Texture2D_5( "T_StoneDetail_01_BaseColor", 2D ) = "white" {}
		Material_Texture2D_6( "T_Landscape_Grass_01_BaseColor", 2D ) = "white" {}
		Material_Texture2D_7( "RM Texture", 2D ) = "white" {}
		Material_Texture2D_8( "T_Landscape_Grass_01_RM", 2D ) = "white" {}
