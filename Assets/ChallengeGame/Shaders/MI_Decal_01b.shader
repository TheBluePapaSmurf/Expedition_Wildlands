Shader "Unreal/MI_Decal_01b"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Ornamentation_02_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Landscape_Grass_01_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Landscape_Grass_01_RM", 2D ) = "white" {}
		Material_Texture2D_3( "T_Ornamentation_02_RMH", 2D ) = "white" {}
