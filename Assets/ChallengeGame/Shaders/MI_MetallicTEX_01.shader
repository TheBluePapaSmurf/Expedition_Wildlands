Shader "Unreal/MI_MetallicTEX_01"
{
    Properties
    {
		...
		Material_Texture2D_0( "Detail Normal", 2D ) = "white" {}
		Material_Texture2D_1( "Texture Normal", 2D ) = "white" {}
		Material_Texture2D_2( "Texture BaseColor", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_MetallicTEX_01.hlsl"
