Shader "Unreal/MI_Stone_Red"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_RockDetail_01_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_RockDetail_02_Normal", 2D ) = "white" {}
		Material_Texture2D_2( "T_Landscape_Grass_01_BaseColor", 2D ) = "white" {}
		Material_Texture2D_3( "T_Landscape_Grass_01_RM", 2D ) = "white" {}
