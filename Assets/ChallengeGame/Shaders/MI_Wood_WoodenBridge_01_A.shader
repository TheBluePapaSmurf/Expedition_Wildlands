Shader "Unreal/MI_Wood_WoodenBridge_01_A"
{
    Properties
    {
		...
		Material_Texture2D_0( "Texture Normal", 2D ) = "white" {}
		Material_Texture2D_1( "Texture BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "Edge Texture", 2D ) = "white" {}
		Material_Texture2D_3( "Texture RMH", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Wood_WoodenBridge_01_A.hlsl"
