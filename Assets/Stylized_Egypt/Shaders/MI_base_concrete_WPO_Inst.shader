Shader "Unreal/MI_base_concrete_WPO_Inst"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_concrete_paint_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_concrete_paint_BaseColor", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_base_concrete_WPO_Inst.hlsl"
