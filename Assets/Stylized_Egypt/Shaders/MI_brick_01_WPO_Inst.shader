Shader "Unreal/MI_brick_01_WPO_Inst"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_brick_01_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_brick_01_BaseColor", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_brick_01_WPO_Inst.hlsl"
