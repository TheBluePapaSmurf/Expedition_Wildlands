...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.097587,0.068478,0.027321,1.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.097587,0.068478,0.027321,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(1.000000,1.000000,0.000000,0.209524);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local5 = PositiveClampedPow(Local3.rgb,((MaterialFloat3)Material.PreshaderBuffer[4].x));
	MaterialFloat Local6 = lerp(Material.PreshaderBuffer[4].z,Material.PreshaderBuffer[4].y,Local5.x);
	MaterialFloat Local7 = saturate(Local6);
	MaterialFloat Local8 = (Material.PreshaderBuffer[4].w * Local7.r);
