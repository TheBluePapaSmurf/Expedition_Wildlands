...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.254152,0.141263,0.049707,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.254152,0.141263,0.049707,1.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local9 = (Local7.rgb * ((MaterialFloat3)Material.PreshaderBuffer[5].x));
	...
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat3(1.00000000,0.00000000,0.00000000).xy,Material.PreshaderBuffer[5].y);
