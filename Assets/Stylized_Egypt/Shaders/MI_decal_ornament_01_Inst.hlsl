...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[4] = float4(0.500000,0.500000,0.500000,0.390476);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local5 = (((MaterialFloat3)1.00000000) - Local3.rgb);
	MaterialFloat3 Local6 = (Local5 * ((MaterialFloat3)2.00000000));
	MaterialFloat3 Local7 = (Local6 * Material.PreshaderBuffer[4].xyz);
	MaterialFloat3 Local8 = (((MaterialFloat3)1.00000000) - Local7);
	MaterialFloat3 Local9 = (Local3.rgb * ((MaterialFloat3)2.00000000));
	MaterialFloat3 Local10 = (Local9 * Material.PreshaderBuffer[3].xyz);
	MaterialFloat Local11 = select((Local3.rgb.r >= 0.50000000), Local8.r, Local10.r);
	MaterialFloat Local12 = select((Local3.rgb.g >= 0.50000000), Local8.g, Local10.g);
	MaterialFloat Local13 = select((Local3.rgb.b >= 0.50000000), Local8.b, Local10.b);
	MaterialFloat Local14 = (Local3.a * Material.PreshaderBuffer[4].w);

	PixelMaterialInputs.EmissiveColor = Local0;
	PixelMaterialInputs.Opacity = Local14;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = MaterialFloat3(MaterialFloat2(Local11,Local12),Local13);
