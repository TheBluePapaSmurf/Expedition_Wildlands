...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.286458,0.162641,0.052832,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[5] = float4(0.500000,0.500000,0.500000,0.200000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(500.000000,1.200000,-0.200000,0.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.286458,0.162641,0.052832,0.650000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.571429,1.205915,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local17 = PositiveClampedPow(Local2.b,Material.PreshaderBuffer[6].x);
	MaterialFloat Local18 = lerp(Material.PreshaderBuffer[6].z,Material.PreshaderBuffer[6].y,Local17);
	MaterialFloat Local19 = saturate(Local18);
	MaterialFloat3 Local20 = lerp(Material.PreshaderBuffer[7].xyz,MaterialFloat3(MaterialFloat2(Local14,Local15),Local16),Local19.r);
	MaterialFloat Local21 = lerp(Material.PreshaderBuffer[8].y,Material.PreshaderBuffer[8].x,Local19.r);
