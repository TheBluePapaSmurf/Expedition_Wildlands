...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(0.502886,0.208637,0.012983,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.502886,0.208637,0.012983,0.900000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(1.320000,0.000000,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local8 = ProcessMaterialLinearGreyscaleTextureLookup(Texture2DSampleBias(Material_Texture2D_1,sampler_Material_Texture2D_1,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local9 = MaterialStoreTexSample(Parameters, Local8, 1);
	MaterialFloat3 Local10 = (Local8.rgb * ((MaterialFloat3)Material.PreshaderBuffer[5].x));
