Shader "Unreal/MI_part_ornament_01_Inst"
{
    Properties
    {
		...
		Material_Texture2D_0( "building_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "Normal", 2D ) = "white" {}
		Material_Texture2D_2( "BaseColor", 2D ) = "white" {}
		Material_Texture2D_3( "T_part_ornament_MaskRGB", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_part_ornament_01_Inst.hlsl"
