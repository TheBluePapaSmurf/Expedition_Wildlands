Shader "Unreal/MI_pyramid_Inst"
{
    Properties
    {
		...
		Material_Texture2D_0( "texture_vertex_normal", 2D ) = "white" {}
		Material_Texture2D_1( "building_Normal", 2D ) = "white" {}
		Material_Texture2D_2( "Normal", 2D ) = "white" {}
		Material_Texture2D_3( "T_noise_pyramid_Normal", 2D ) = "white" {}
		Material_Texture2D_4( "T_pyramid_Mask", 2D ) = "white" {}
		Material_Texture2D_5( "BaseColor", 2D ) = "white" {}
		Material_Texture2D_6( "texture_vertex_color", 2D ) = "white" {}
