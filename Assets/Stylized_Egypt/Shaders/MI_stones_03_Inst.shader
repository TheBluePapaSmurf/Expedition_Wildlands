Shader "Unreal/MI_stones_03_Inst"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_stones_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_stones_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_moss_BaseColor", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_stones_03_Inst.hlsl"
