...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[2] = float4(0.820000,0.000000,0.000000,0.000000);//(Unknown)
}float3 GetMaterialWorldPositionOffset(FMaterialVertexParameters Parameters)
{
	FLWCVector3 Local8 = GetWorldPosition(Parameters);
	FLWCVector3 Local9 = TransformLocalPositionToWorld(Parameters, MaterialFloat3(0.00000000,0.00000000,0.00000000));
	FLWCVector3 Local10 = LWCSubtract(DERIV_BASE_VALUE(Local8), Local9);
	MaterialFloat3 Local11 = LWCToFloat(DERIV_BASE_VALUE(Local10));
	MaterialFloat Local12 = length(DERIV_BASE_VALUE(Local11));
	MaterialFloat Local13 = (DERIV_BASE_VALUE(Local12) * 0.03000000);
	FLWCVector3 Local14 = LWCAdd(LWCPromote(((MaterialFloat3)View.GameTime)), GetObjectWorldPosition(Parameters));
	FLWCVector3 Local15 = LWCMultiply(Local14, LWCPromote(((MaterialFloat3)0.62831855)));
	MaterialFloat3 Local16 = LWCSin(Local15);
	MaterialFloat3 Local17 = (((MaterialFloat3)1.00000000) + DERIV_BASE_VALUE(Local16));
	MaterialFloat3 Local18 = (DERIV_BASE_VALUE(Local17) * ((MaterialFloat3)0.50000000));
	MaterialFloat3 Local19 = (((MaterialFloat3)DERIV_BASE_VALUE(Local13)) * DERIV_BASE_VALUE(Local18));
	return Local19;;
}
