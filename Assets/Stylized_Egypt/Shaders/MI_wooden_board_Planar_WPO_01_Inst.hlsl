...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(450.000000,0.002222,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.428690,0.496933,0.502886,1.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.428690,0.496933,0.502886,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.571310,0.503067,0.497114,1.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local7 = lerp(Local5.rgb,MaterialFloat3(0.00000000,0.00000000,1.00000000),Material.PreshaderBuffer[1].z);
	...
	MaterialFloat3 Local8 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[2].xyz,Material.PreshaderBuffer[1].w);
	MaterialFloat Local9 = MaterialStoreTexCoordScale(Parameters, Local3, 2);
	MaterialFloat4 Local10 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,sampler_Material_Texture2D_1,Local3,View.MaterialTextureMipBias));
	...
	PixelMaterialInputs.BaseColor = MaterialFloat3(MaterialFloat2(Local18,Local19),Local20);
