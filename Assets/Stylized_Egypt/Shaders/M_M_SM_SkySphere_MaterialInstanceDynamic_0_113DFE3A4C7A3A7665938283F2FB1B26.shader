Shader "Unreal/M_M_SM_SkySphere_MaterialInstanceDynamic_0_113DFE3A4C7A3A7665938283F2FB1B26"
{
    Properties
    {
		...
		Material_Texture2D_1( "EmissiveColorTexture", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_M_SM_SkySphere_MaterialInstanceDynamic_0_113DFE3A4C7A3A7665938283F2FB1B26.hlsl"
