...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[6] = float4(0.751373,-0.406073,-0.520138,1.000000);//(Unknown)
	Material.PreshaderBuffer[7] = float4(0.751373,-0.406073,-0.520138,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.751373,-0.406073,-0.520138,0.000300);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local27 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,sampler_Material_Texture2D_1,DERIV_BASE_VALUE(Local25),View.MaterialTextureMipBias));
	...
	MaterialFloat4 Local32 = ProcessMaterialGreyscaleTextureLookup(Texture2DSampleBias(Material_Texture2D_2,sampler_Material_Texture2D_2,DERIV_BASE_VALUE(Local30),View.MaterialTextureMipBias));
	...
	MaterialFloat4 Local47 = ProcessMaterialGreyscaleTextureLookup(Texture2DSampleBias(Material_Texture2D_2,sampler_Material_Texture2D_2,DERIV_BASE_VALUE(Local45),View.MaterialTextureMipBias));
